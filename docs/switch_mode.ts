...
const style_button = document.getElementById('style_button');

style_button.addEventListener('click', (e) => {
    console.log('Switching styles');
    const current_css = (document.getElementById("aux_style") as HTMLLinkElement).href;
